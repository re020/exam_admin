<template>
  <div>
    ...
    <div class="table-header">
      <el-form :inline="true" :model="page" class="demo-form-inline" size="mini">
        <el-form-item label="题库名">
          <el-input v-model="page.params.bankName" placeholder="题库名" clearable/>
        </el-form-item>
        <el-form-item label="学院">
          <el-select v-model="page.params.bankCollege" clearable filterable placeholder="请选择">
            <el-option
      ...
      <el-divider/>
      <el-button v-if="permission.indexOf('bank:add') >= 0" type="primary" size="mini" @click="toAdd">添加</el-button>
    </div>
    <!-- 搜索框结束 -->

    <!-- 题库列表开始 -->
    <el-row v-loading="this.$store.getters.loading">
      <el-col v-for="bank in page.list" :span="6" :key="bank.bankId" :offset="1">
        <el-card :body-style="{ padding: '0px' }" style="padding: 0px" shadow="hover" class="bank-card">
          ...
          <el-dropdown style="float: right;">
            <span class="el-dropdown-link">
              <el-button icon="el-icon-menu" plain size="mini"/>
            </span>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <el-button v-if="permission.indexOf('bank:update') >= 0" type="success" size="mini" @click="toUpdate(bank.bankId)">编辑</el-button>
              </el-dropdown-item>
              <el-dropdown-item>
                <el-button v-if="permission.indexOf('know:list') >= 0" type="primary" size="mini" @click="toKnowledge(bank.bankId)">知识点</el-button>
              </el-dropdown-item>
              <el-dropdown-item>
                <el-button v-if="permission.indexOf('bank:delete') >= 0" type="danger" size="mini" @click="toDelete(bank.bankId)">删除</el-button>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </el-card>
    ...
    <!-- 新增修改弹窗 -->
    <el-dialog v-loading="this.$store.getters.loading" :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form ref="bank" :rules="rules" :model="bank" label-width="80px" size="mini">
        <el-form-item label="题库名称" prop="bankName">
          <el-input v-model="bank.bankName" clearable/>
        </el-form-item>
        <el-form-item label="学院">
